...
```
Gateway → [Input Interfaces + Schedule Manager] → Agent → Reports
```
...
## Analysis Loop (LLM)
The agent loops around a single LLM for analysis:
...
2. Results collected and sent to Agent via payload
3. Agent creates/updates session context
